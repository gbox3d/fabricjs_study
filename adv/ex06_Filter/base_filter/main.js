...
async function main() {
    ...
    const object = await new Promise((resolve, reject) => {
        fabric.Image.fromURL('../../../res/oota_nao.jpg',resolve);
    })
    ...
    const _patt = await new Promise((resolve, reject) => {
        fabric.Image.fromURL('../../../res/blur_pat01.png',resolve);
    })

    const alphaMixFilter = new fabric.Image.filters.AlphaMixer({
        image: _patt,
        mode: 'mask',
        alpha: 0.5
    })

    object.filters.push(alphaMixFilter)
    object.applyFilters()
