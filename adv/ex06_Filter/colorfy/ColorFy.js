export default (global) => {
     ...
     * object.applyFilters();
     */
    filters.ColorFy = createClass(filters.BaseFilter, /** @lends fabric.Image.filters.SwapColor.prototype */ {
      ...
      fragmentSource: 'precision highp float;\n' +
        ...
        //   'vec3 delta = abs(colorSource.rgb - color.rgb);\n' +
          'gl_FragColor = color * colorSource;\n' +
        '}',
      ...
      */
      applyTo2d: function(options) {
        ...
        for (i = 0; i < len; i += 4) {
          data[i] = source[0] * data[i];
          data[i + 1] = source[1] * data[i + 1];
          data[i + 2] = source[2] * data[i + 2];
     ...
     */
    fabric.Image.filters.ColorFy.fromObject = fabric.Image.filters.BaseFilter.fromObject;
  }